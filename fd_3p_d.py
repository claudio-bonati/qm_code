...
if __name__=="__main__":
  ...
  risA=fd_3p_d_solver(pot_l, xmin, xmax, N)
  risB=fd_3p_d_solver(pot_l, xmin, xmax, 2*N)
  risC=fd_3p_d_solver(pot_l, xmin, xmax, 3*N)
  risD=fd_3p_d_solver(pot_l, xmin, xmax, 4*N)

  risB_extrap=fd_3p_d_solver_extrap(pot_l, xmin, xmax, 2*N)
